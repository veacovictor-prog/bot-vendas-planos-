...
function protectionPanelEmbed(settings, shop) {
  return new EmbedBuilder()
    ...
    .setDescription("Gerencie protecoes basicas contra links, contas recentes e entradas suspeitas.")
    .addFields(
...
async function handleStoreMoreOption(interaction) {
  ...
  const map = {
    ...
    oauth2: {
      title: "OAuth2",
      description: "Use tickets e cargos de cliente para organizar entregas e suporte."
    }
  };
